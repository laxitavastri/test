            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Draft Sales</h1>                       
                    </div>
                        ...
                        <div class="form-card card shadow mb-4">
                            <div class="card-body">
                                ...
                                <div class="row pt-5 pb-5">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select :class="'form-control thickness-'+k" v-model="input.thickness" >
                                                                        ...
                                                                        <template v-for="tdata in input.thicknessList">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select  :class="'form-control size-'+k" v-model="input.size" @change="changeTotalAmount(k)" >
                                                                        ...
                                                                        <template v-for="tdata in input.sizeList">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group" v-if="other_charge!=''">
                                                    ...
                                                    <input class="form-control" v-model="other_charge_amount" @keyup="changeGrandTotal(); change_other_charge()" type="number" placeholder="Other Charges Amount">
                                                </div>  
                                    ...
                                    <div class="col-md-8" v-if="$route.params.mode=='payment'">
                                        <div class="card">
                                            <div class="card-header">
                                                Payment Details
                                            </div>
...
export default {
    ...
    methods: {
        change_other_charge(){
            let vl=this.other_charge_amount;
        ...
        getSalesDetails(){
            ...
            axios({
                    ...
                    ev.payment_history=data.data.payment;
